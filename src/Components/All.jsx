...
<span className="loading loading-ring loading-xl"></span>
  ...
  <input type="search" name="search" className='' placeholder="Search" />
            ...
            <button className='border-0 px-4 py-2 rounded-r-xl bg-[#FACC15]'>Search</button>
            </form>
            <form onSubmit={handleSort}>
                <button className='border px-4 py-2 rounded-2xl hover:bg-[#FACC15]'>Sort by price(asc)</button>
            </form>
            </div>
