        ...
        <div className="flex items-center justify-center p-12 md:p-24 gap-4 md:gap-20 shadow-2xl">
          <div>
            <div>
              ...
              <p>
                We ensure every property is genuine and verified. No hidden
                information, no surprises — just the home you deserve.
              </p>
            </div>
            <div className="my-2">
              <p className="text-2xl">__Wide Range of Properties</p>
              <p>
                From luxury villas to cozy apartments, we have properties to fit
            ...
            <div>
              ...
              <p>
                Our platform makes searching, contacting owners, and booking
                simple and transparent. Hassle-free experience guaranteed.
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="flex items-center justify-center p-12 md:p-24 gap-4 md:gap-20 shadow-2xl">
          ...
          <div>
            <div className="mb-2">
              ...
              <p>
                Learn how to choose the perfect property, check legal documents,
            ...
            <div className="mb-2">
              ...
              <p>
                Discover smart property investments, market hotspots, and rental
                income strategies.
              </p>
            </div>
            <div className="mb-2">
              ...
              <p>
                Stay updated with local real estate prices, emerging
                neighborhoods, and upcoming projects.
              </p>
            </div>
            <div className="mb-2">
              <p className="text-2xl">__DIY Home Improvement</p>
              <p>
                Simple tips to increase your property’s value and make your home
                more comfortable.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center p-12 md:p-24 gap-4 md:gap-20 shadow-2xl">
          <div>
            <div className="mb-2">
              ...
              <p>
                Use our search filters by location, price, and property type to
            ...
            <div className="mb-2">
              ...
              <p>
                Yes! Every property on HomeNest is carefully verified to ensure
            ...
            <div className="mb-2">
              ...
              <p>
                Yes. All transactions are encrypted and handled securely to
